          ...
          <table className="w-full text-left text-xs border-collapse">
            <thead className="bg-slate-50 text-slate-700 font-bold border-b border-slate-200">
              <tr>
                ...
                <th className="p-2 border-r border-slate-200 text-right text-emerald-700 font-semibold">Cash.Rec</th>
                <th className="p-2 border-r border-slate-200 text-right text-rose-700">Cash.Pay</th>
                <th className="p-2 border-r border-slate-200 text-right text-blue-700 font-semibold">Bank.Rec</th>
            ...
            <tbody className="divide-y divide-slate-200 bg-white font-mono text-[11px]">
              {filteredEntries.map((row) => (
                <tr key={row.id} className="hover:bg-sky-50/30">
                  ...
                  <td className="p-2 border-r border-slate-200 text-right text-emerald-700 font-semibold">{formatCurrency(row.cash_received)}</td>
                  <td className="p-2 border-r border-slate-200 text-right text-rose-700">{formatCurrency(row.cash_payment)}</td>
                  <td className="p-2 border-r border-slate-200 text-right text-blue-700 font-semibold">{formatCurrency(row.bank_received)}</td>
