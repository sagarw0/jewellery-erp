...
export const THEMES: Record<ThemeId, ThemeConfig> = {
  ...
  'apple-glass': {
    ...
    bgGradient: 'bg-gradient-to-br from-[#cbd8e8] via-[#bfd2e8] to-[#d8e2ed] text-slate-950',
    cardBg: 'bg-white/90 backdrop-blur-2xl border border-white/95 shadow-[0_10px_35px_rgba(0,0,0,0.08)] text-slate-950',
    cardBorder: 'border-white/95',
    cardHover: 'hover:border-blue-400 hover:shadow-[0_15px_45px_rgba(0,0,0,0.12)] hover:-translate-y-0.5',
    ...
    secondaryBtn: 'bg-white/90 hover:bg-white text-slate-800 border border-slate-200/90 backdrop-blur-md shadow-2xs font-bold',
    accentText: 'text-blue-900 font-bold',
    badgeBg: 'bg-blue-100/90 text-blue-950 border border-blue-300 font-bold backdrop-blur-md',
    headerBg: 'bg-white/92 backdrop-blur-2xl border-b border-white/90 text-slate-950 shadow-[0_4px_20px_rgba(0,0,0,0.06)]',
    appBg: 'bg-[#cddae8]',
    textPrimary: 'text-slate-950 font-bold',
    textSecondary: 'text-slate-700 font-medium',
    textMuted: 'text-slate-500',
    subnavBg: 'bg-white/88 backdrop-blur-xl border-b border-white/90 text-slate-900',
    ...
    inputBg: 'bg-white/95 text-slate-950 placeholder-slate-400 shadow-inner font-medium',
    ...
    glassCard: 'bg-white/90 backdrop-blur-2xl border border-white/95 shadow-[0_10px_35px_rgba(0,0,0,0.08)] text-slate-950',
    glassBorder: 'border-white/95',
  },
};
