...
export const THEMES: Record<ThemeId, ThemeConfig> = {
  ...
  'apple-glass': {
    ...
    subtitle: 'Translucent frosted-glass surfaces, blur & soft highlights',
    isDark: false,
    swatchPrimary: '#0071e3',
    swatchSecondary: '#f5f5f7',
    bgGradient: 'bg-gradient-to-br from-[#e6ebf4] via-[#f2f5fa] to-[#e1e7f2] text-slate-900',
    cardBg: 'bg-white/75 backdrop-blur-2xl backdrop-saturate-150 text-slate-900',
    cardBorder: 'border-white/90 ring-1 ring-black/[0.04] shadow-[0_8px_32px_rgba(0,0,0,0.04)]',
    cardHover: 'hover:bg-white/90 hover:border-white hover:shadow-[0_12px_40px_rgba(0,0,0,0.08)] hover:-translate-y-0.5',
    primaryBtn: 'bg-gradient-to-b from-[#0077ED] to-[#0062C4] hover:from-[#0082FB] hover:to-[#006CD9] text-white font-semibold shadow-[0_4px_14px_rgba(0,118,237,0.35)] active:scale-[0.98]',
    secondaryBtn: 'bg-white/70 hover:bg-white/90 text-slate-800 border border-white/90 shadow-[0_2px_8px_rgba(0,0,0,0.04)] backdrop-blur-md',
    accentText: 'text-[#0071E3]',
    badgeBg: 'bg-white/80 text-[#0071E3] border border-white/90 shadow-2xs backdrop-blur-md font-semibold',
    headerBg: 'bg-white/70 backdrop-blur-2xl backdrop-saturate-180 border-b border-black/[0.06] text-slate-900',
    appBg: 'bg-[#eef2f8]',
    textPrimary: 'text-slate-900',
    textSecondary: 'text-slate-600',
    textMuted: 'text-slate-400',
    subnavBg: 'bg-white/55 backdrop-blur-xl border-b border-black/[0.04] text-slate-800',
    activePill: 'bg-[#0071E3] text-white font-semibold shadow-[0_4px_12px_rgba(0,113,227,0.3)]',
    inputBorder: 'border-black/[0.08] focus:border-[#0071E3] focus:ring-2 focus:ring-[#0071E3]/20',
    inputBg: 'bg-white/70 backdrop-blur-md text-slate-900 placeholder-slate-400 shadow-inner',
    tableHeaderBg: 'bg-white/55 backdrop-blur-md text-slate-700 border-b border-black/[0.06]',
    tableRowHover: 'hover:bg-white/65',
    glassCard: 'bg-white/75 backdrop-blur-2xl backdrop-saturate-150 border border-white/90 shadow-[0_8px_32px_rgba(0,0,0,0.05)] ring-1 ring-black/[0.03] text-slate-900',
