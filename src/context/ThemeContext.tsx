...
export const THEMES: Record<ThemeId, ThemeConfig> = {
  ...
  'apple-glass': {
    ...
    bgGradient: 'bg-gradient-to-br from-[#eef4fb] via-[#e2edfb] to-[#f8fafc] text-slate-950',
    cardBg: 'bg-white/80 backdrop-blur-2xl border border-white/90 shadow-[0_8px_30px_rgb(0,0,0,0.04)] text-slate-950',
    cardBorder: 'border-white/90',
    cardHover: 'hover:border-blue-400 hover:shadow-[0_12px_40px_rgb(0,0,0,0.08)] hover:-translate-y-0.5',
    ...
    headerBg: 'bg-white/85 backdrop-blur-2xl border-b border-white/80 text-slate-950 shadow-[0_2px_15px_rgba(0,0,0,0.03)]',
    appBg: 'bg-[#f0f4f9]',
    textPrimary: 'text-slate-950 font-bold',
    textSecondary: 'text-slate-700 font-medium',
    textMuted: 'text-slate-500',
    subnavBg: 'bg-white/80 backdrop-blur-xl border-b border-white/80 text-slate-900',
    ...
    glassCard: 'bg-white/80 backdrop-blur-2xl border border-white/90 shadow-[0_8px_30px_rgb(0,0,0,0.04)] text-slate-950',
