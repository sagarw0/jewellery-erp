...
export const THEMES: Record<ThemeId, ThemeConfig> = {
  ...
  'apple-glass': {
    ...
    cardBg: 'bg-white/[0.08] backdrop-blur-2xl backdrop-saturate-200 border border-white/20 shadow-xs ring-1 ring-white/10 text-white',
    cardBorder: 'border-white/20 ring-1 ring-white/10',
    cardHover: 'hover:bg-white/[0.14] hover:border-white/40 hover:shadow-xs hover:-translate-y-0.5',
    primaryBtn: 'bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-600 hover:from-sky-400 hover:to-indigo-500 text-white font-semibold shadow-xs border border-white/20 active:scale-[0.98]',
    secondaryBtn: 'bg-white/10 hover:bg-white/20 text-white border border-white/20 backdrop-blur-md shadow-2xs font-medium',
    accentText: 'text-sky-300',
    badgeBg: 'bg-white/15 text-sky-300 border border-white/25 font-semibold backdrop-blur-md',
    ...
    activePill: 'bg-gradient-to-r from-sky-500 to-blue-600 text-white font-semibold shadow-xs border border-white/30',
    ...
    glassCard: 'bg-white/[0.08] backdrop-blur-2xl backdrop-saturate-200 border border-white/20 shadow-xs ring-1 ring-white/10 text-white',
