...
export const THEMES: Record<ThemeId, ThemeConfig> = {
  ...
  'apple-glass': {
    ...
    bgGradient: 'bg-gradient-to-br from-[#dce6f2] via-[#d0e0f2] to-[#e8eef5] text-slate-950',
    cardBg: 'bg-white/85 backdrop-blur-2xl border border-white/90 shadow-[0_8px_30px_rgb(0,0,0,0.06)] text-slate-950',
    cardBorder: 'border-white/90',
    cardHover: 'hover:border-blue-400 hover:shadow-[0_12px_40px_rgb(0,0,0,0.10)] hover:-translate-y-0.5',
    ...
    secondaryBtn: 'bg-white/80 hover:bg-white text-slate-800 border border-slate-200/90 backdrop-blur-md shadow-2xs font-bold',
    accentText: 'text-blue-900 font-bold',
    badgeBg: 'bg-blue-50 text-blue-900 border border-blue-200 font-bold backdrop-blur-md',
    headerBg: 'bg-white/90 backdrop-blur-2xl border-b border-white/80 text-slate-950 shadow-[0_2px_15px_rgba(0,0,0,0.04)]',
    appBg: 'bg-[#d8e2ee]',
    textPrimary: 'text-slate-950 font-bold',
    textSecondary: 'text-slate-700 font-medium',
    textMuted: 'text-slate-500',
    subnavBg: 'bg-white/85 backdrop-blur-xl border-b border-white/80 text-slate-900',
    ...
    inputBg: 'bg-white/90 text-slate-950 placeholder-slate-400 shadow-inner font-medium',
    tableHeaderBg: 'bg-slate-100/90 backdrop-blur-md text-slate-900 font-bold border-b border-slate-200',
    tableRowHover: 'hover:bg-blue-50/50',
    glassCard: 'bg-white/85 backdrop-blur-2xl border border-white/90 shadow-[0_8px_30px_rgb(0,0,0,0.06)] text-slate-950',
